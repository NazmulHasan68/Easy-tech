...
export interface ServiceProjectGridProps {
  /** Section heading — first part */
  titleMain: string;
  /** Section heading — gradient part */
  titleGradient: string;
  /** Subtitle paragraph */
  subtitle?: string;
  /** Projects array */
  projects: ServiceProject[];
  /** Base href for project detail links e.g. "/services/web" */
  basePath: string;
  /** Card footer left label e.g. "Project Details" */
  cardLabel?: string;
}
...
export default function ServiceProjectGrid({
  titleMain,
  titleGradient,
  subtitle = "We craft scalable, high-performance digital solutions that help businesses grow and stand out.",
  projects,
  basePath,
    ...
    >
      ...
      <div className="container-xl">
        ...
        <div className="text-center mb-16">
          ...
          >
            <span className="word inline-block will-change-transform">{titleMain}&nbsp;</span>
            <span className="word inline-block will-change-transform gradient-text">{titleGradient}</span>
          </h2>
