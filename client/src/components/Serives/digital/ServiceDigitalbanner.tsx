  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full">
        ...
        >
          {/* Breadcrumb */}
          <div  onClick={() => window.scrollBy({ top: 450, behavior: 'smooth' })} className=" cursor-pointer inline-flex items-center gap-2 mb-4 md:mb-6 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs uppercase tracking-wider">
